          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-orange-500 h-full w-[92%] shadow-[0_0_10px_rgba(249,115,22,0.8)]"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-slate-900/50 border border-cyan-500/20 p-6 rounded-2xl">
          ...
          <p className="text-gray-400 leading-relaxed">
            Welcome back, Survivor. Your current clearance level allows you to view the 2026 AI Mastery Blueprint.
          </p>
          <button className="mt-6 px-6 py-3 bg-transparent border border-cyan-500 text-cyan-400 font-bold rounded-lg hover:bg-cyan-500 hover:text-black transition-all">
            DOWNLOAD INTEL PACK
          </button>
        </div>
