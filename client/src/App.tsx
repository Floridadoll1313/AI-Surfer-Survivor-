...
// --- REMAINING PAGE COMPONENTS (To be moved to /pages/ later) ---
...
const MapPage = () => {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    setCoords({ x: Math.floor(e.clientX - bounds.left), y: Math.floor(e.clientY - bounds.top) });
  };
  ...
  return (
    <div style={{ padding: '40px', color: '#ffffff', display: 'flex', gap: '30px', flexWrap: 'wrap', justifyContent: 'center' }}>
      ...
      <div style={{ width: '280px', background: 'rgba(17, 34, 64, 0.6)', padding: '20px', borderRadius: '15px', border: '1px solid #35c9ff' }}>
        <h3 style={{ color: '#35c9ff', borderBottom: '1px solid #35c9ff', paddingBottom: '10px' }}>SYSTEM STATUS</h3>
        <p>OXYGEN: <span style={{ color: '#64ffda' }}>98%</span></p>
        <p>HEART RATE: <span style={{ color: '#64ffda' }}>72 BPM</span></p>
      </div>
    </div>
  );
};
